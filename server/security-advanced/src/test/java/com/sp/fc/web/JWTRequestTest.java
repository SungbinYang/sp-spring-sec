...
public class JWTRequestTest extends WebIntegrationTest {
    ...
    void before() {
        ...
        SpUser user = userService.save(SpUser.builder().email("user1").password("1111").enabled(true).build());
    ...
    void test_1() {
        ...
        HttpEntity<UserLoginForm> body = new HttpEntity<>(UserLoginForm.builder().username("user1").password("1111").build());
