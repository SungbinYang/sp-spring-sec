...
public class JWTSimpleTest {
    ...
    void test_1(){
        String okta_token = Jwts.builder().addClaims(
                Map.of("name", "sungbin", "price", 30000)
        ).signWith(SignatureAlgorithm.HS256, "sungbin").compact();
    ...
    void test_2() {
        ...
        String oauth0_token = JWT.create().withClaim("name", "sungbin").withClaim("price", 30000)
